                ...
                <div class="row card-body">
                    <div class="col-md-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <form action="check-result-update" method="GET" id="ch_update_form">
                                        ...
                                        <div class="com-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="button" onclick="reset_sid_2()" value="Reset" class="btn btn-block">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    if($student_inf != false){
                        ...
                        <div class="row heading_result">Student Result Update</div>
                        <div class="row">
                            <?php
                            $year  = 2005;
                                foreach ($student_inf as $row) {
                                    $result_img_path = $this->get_result->get_img_path($row->s_resultentry_sid);
                                ?>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <form action="set_update_result" method="POST">
                                            <table class="">
                                                <tbody>
                                                    <tr>
                                                        <td class="f_col">ID</td>
                                                        <td class="s_col" colspan="2">: <?php echo $row->s_resultentry_sid; ?> <span style="color:red; font-weight:bold">! not editable</span><input type="hidden" name="stdId" id="stdId" value="<?php echo $row->s_resultentry_sid; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="f_col">Name</td>
                                                        <td class="s_col" colspan="2">: <input type="text" name="stdName" id="stdName" value="<?php echo $row->s_resultentry_sname; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="f_col">Batch</td>
                                                        <td class="s_col" colspan="2">: <input type="text" name="stdBatch" id="stdBatch" value="<?php echo $row->s_resultentry_batch; ?>"></td>
                                                    </tr>
    
                                                    <tr>
                                                        <td class="f_col">Department</td>
                                                        <td class="s_col" colspan="2">: <input type="text" name="stdDpt" id="stdDpt" value="<?php echo $row->s_resultentry_department; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="f_col">Obtained Degree</td>
                                                        <td class="s_col" colspan="2">: <input type="text" name="stddgr" id="stddgr" value="<?php echo $row->s_resultentry_subject; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="f_col">Ending Semester</td>
                                                        <td class="s_col">: <input type="text" name="semester" id="semester" value="<?php echo $row->s_resultentry_semester; ?>"></td>
                                                        <td class="s_col">: <input type="text" name="year" id="year" value="<?php echo $row->s_resultentry_semester_year; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="f_col">CGPA</td>
                                                        <td class="s_col" colspan="2">: <input type="text" name="cgpa" id="cgpa" value="<?php echo $row->s_resultentry_cgpa; ?>" required></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="f_col">Published Date</td>
                                                        <td class="s_col">: <input type="text" name="pDate"  value="<?php echo $row->pdate; ?>" readonly></td><td class="s_col">: <input type="date" name="pDate_new" id="pDate_new"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        <?php
                        ...
                        ?>
                        <div class="col-md-8">
                            <span style="color: white;">No Result Found. Please Result Entry First.</span>
